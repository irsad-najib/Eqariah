    ...
    return (
        <main>
            ...
            <section className=" p-[10] lg:p-5">
                <h1 className="flex justify-center text-center text-[8vw] m-[4%] font-bold lg:text-4xl lg:m-4">Our Client</h1>
                <a className="flex justify-center text-center text-[3.5vw] pb-[4%] lg:text-xl lg:pb-4">We have been working with some Fortune 500++ clients</a>
            ...
            <section className="p-[10%] lg:p-5">
                <h1 className="flex text-[8vw] font-bold justify-center text-center lg:text-4xl">Manage your entire community in a single system</h1>
                <a className="flex justify-center p-[4%] md:text-[3vw] lg:text-xl lg:p-5">who is Nextcent suitable for?</a>
                <div className="container mx-auto px-[4%] py-[20%] lg:p-4">
                    <div className="flex flex-col lg:grid lg:grid-cols-3 gap-20">
                        <div className="text-center shadow-lg bg-gray-50">
                            ...
                            <p className="text-gray-600 text-[3.5vw] m-[4%] lg:text-xl lg:m-4">
            ...
            <section className=" flex flex-col p-[10%] lg:p-20 justify-evenly items-center">
                ...
                <div>
                    <h1 className="text-[8vw] lg:text-4xl font-bold py-[4%] text-center">How to design your site footer like we did</h1>
            ...
            <section className="flex flex-col p-[10%] lg:p-20 justify-evenly items-center bg-[#F5F7FA]">
                ...
                <div >
                    <a className='md:text-[3vw] lg:text-xl'>Maecenas dignissim justo eget nulla rutrum molestie. Maecenas lobortis sem dui, vel rutrum risus tincidunt ullamcorper. Proin eu enim metus. Vivamus sed libero ornare, tristique quam in, gravida enim. Nullam ut molestie arcu, at hendrerit elit. Morbi laoreet elit at ligula molestie, nec molestie mi blandit. Suspendisse cursus tellus sed augue ultrices, quis tristique nulla sodales. Suspendisse eget lorem eu turpis vestibulum pretium. Suspendisse potenti. Quisque malesuada enim sapien, vitae placerat ante feugiat eget. Quisque vulputate odio neque, eget efficitur libero condimentum id. Curabitur id nibh id sem dignissim finibus ac sit amet magna.</a>
            ...
            <section className='p-[10%] lg:p-20'>
                <div>
                    <h1 className='flex justify-center text-[8vw] lg:text-4xl font-bold'>Caring is the new marketing</h1>
                    <a className='flex text-center justify-center md:text-[3vw] lg:text-xl lg:pt-4'>The Nextcent is the best place to read about the lastest membership insght, trends and more. See who's joining the community, read about how our community are increasing their membership income and lot's more</a>
                </div>
                <div className='flex flex-col lg:flex-row p-[10%] lg:p-10 justify-around items-center text-center gap-40 lg:gap-20'>
                    <div className='rounded-md shadow-md p-[4%] '>
                        <Image
                            ...
                            height={200}
                        />
                        <div className='bg-[#f5f7fa] shadow-md absolute w-[58%] text-[3.5vw] lg:text-xl ml-[0.7%] mt-[-10%] md:w-[42%] lg:w-44 lg:-ml-4 lg:-mt-10'>
            ...
            <footer className='bg-black flex flex-col-reverse lg:flex-row text-white p-[10%] justify-center lg:justify-around'>
                ...
                <div className='flex flex-col justify-center lg:ml-72'>
                    <h1 className='py-[4%] font-bold text-[4.3vw] lg:text-2xl md:text-[3.8vw]'>Company</h1>
                    <a className='text-gray-300 text-[3.5vw] md:text-[2. lg:text-xl'>About us</a>
                    <a className='text-gray-300 text-[3.5vw] md:text-[2. lg:text-xl'>Blog</a>
                    <a className='text-gray-300 text-[3.5vw] md:text-[2. lg:text-xl'>Contacts us</a>
                    <a className='text-gray-300 text-[3.5vw] md:text-[2. lg:text-xl'>Pricing</a>
                    <a className='text-gray-300 text-[3.5vw] md:text-[2. lg:text-xl'>Testimonials</a>
                </div>

                <div className='flex flex-col justify-center'>
                    <h1 className='font-bold py-[4%] text-[4.3vw] lg:text-2xl md:text-[3.8vw]'>Support</h1>
                    <a className='text-gray-300 text-[3.5vw] md:text-[2. lg:text-xl'>Help center</a>
                    <a className='text-gray-300 text-[3.5vw] md:text-[2. lg:text-xl'>Term and services</a>
                    <a className='text-gray-300 text-[3.5vw] md:text-[2. lg:text-xl'>Legal</a>
                    <a className='text-gray-300 text-[3.5vw] md:text-[2. lg:text-xl'>Pribacy policy</a>
                    <a className='text-gray-300 text-[3.5vw] md:text-[2. lg:text-xl'>Status</a>
                </div>

                <div className='flex flex-col justify-center'>
                    <h1 className='text-[4.3vw] lg:text-2xl md:text-[3.8vw] font-bold pb-[4%]'>Stay up to date</h1>
