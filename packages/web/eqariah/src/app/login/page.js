...
export default function Login() {
    ...
    useEffect(() => {
        const chekAuthStatus = async () => {
            try {
                const response = await axios.get('http://eqariahapi.hopto.org/api/auth/verify-session', {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post("http://eqariahapi.hopto.org/api/auth/login", formData, {
                headers: {
