            ...
            <div className="flex flex-col">
                ...
                <ul className="flex gap-5">
                    ...
                    <a href="https://dribbble.com" target="_blank" rel="noopener noreferrer">
                        <Image src="/dribble.svg" alt="Follow us on Dribbble" width={40} height={40} className="bg-gray-700 p-1 rounded-full" />
                    </a>
                    <a href="https://twitter.com" target="_blank" rel="noopener noreferrer">
                        <Image src="/X.svg" alt="Follow us on X" width={40} height={40} className="bg-gray-700 p-1 rounded-full" />
                    </a>
                    <a href="https://youtube.com" target="_blank" rel="noopener noreferrer">
                        <Image src="/youtube.svg" alt="Follow us on YouTube" width={40} height={40} className="bg-gray-700 p-1 rounded-full" />
                    </a>
                </ul>
            </div>
